...
bus_data = [ # (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
...
bus_Qd=bus_data[1:,3]
Vm=12.66
Vmin,Vmax=Vm*0.9,Vm*1.1
#	fbus	tbus	r	x	b	rateA	rateB	rateC	ratio	angle	status	angmin	angmax
branch_data = [ # (r and x specified in ohms here, converted to p.u. below)
